var gui = ( function () {
    ...
    gui = {
        ...
        basic: function(){
            ...
            ui.add( params, 'exposure', { min:0, max:10, stype:0, precision:2 } ).onChange( function(){ view.setTone(); } );
            ui.add( params, 'whitePoint', { min:0, max:10, stype:0, precision:1 } ).onChange( function(){ view.setTone(); } );
