...
// glsl mode
CodeMirror.defineMode("glsl",function(g,e){function h(a,c){var b=a.next();if(n[b]){var d=n[b](a,c);if(!1!==d)return d}if('"'==b||"'"==b)return c.tokenize=s(b),c.tokenize(a,c);if(/[\[\]{}\(\),;\:\.]/.test(b))return f=b,"bracket";if(/\d/.test(b))return a.eatWhile(/[\w\.]/),"number";if("/"==b){if(a.eat("*"))return c.tokenize=p,p(a,c);if(a.eat("/"))return a.skipToEnd(),"comment"}if("#"==b)return a.eatWhile(/[\S]+/),a.eatWhile(/[\s]+/),a.eatWhile(/[\S]+/),a.eatWhile(/[\s]+/),"comment";if(q.test(b))return a.eatWhile(q),
"operator";a.eatWhile(/[\w\$_]/);b=a.current();return t.propertyIsEnumerable(b)?(u.propertyIsEnumerable(b)&&(f="newstatement"),"keyword"):v.propertyIsEnumerable(b)?"builtin":w.propertyIsEnumerable(b)?"atom":"word"}function s(a){return function(c,b){for(var d=!1,e,f=!1;null!=(e=c.next());){if(e==a&&!d){f=!0;break}d=!d&&"\\"==e}if(f||!d&&!x)b.tokenize=h;return"string"}}function p(a,c){for(var b=!1,d;d=a.next();){if("/"==d&&b){c.tokenize=h;break}b="*"==d}return"comment"}function r(a,c,b,d,e){this.indented=
a;this.column=c;this.type=b;this.align=d;this.prev=e}function l(a,c,b){return a.context=new r(a.indented,c,b,null,a.context)}function k(a){var c=a.context.type;if(")"==c||"]"==c||"}"==c)a.indented=a.context.indented;return a.context=a.context.prev}var m=g.indentUnit,t=e.keywords||words(glslKeywords),v=e.builtins||words(glslBuiltins),u=e.blockKeywords||words("case do else for if switch while struct"),w=e.atoms||words("null"),n=e.hooks||{},x=e.multiLineStrings,q=/[+\-*&%=<>!?|\/]/,f;return{startState:function(a){return{tokenize:null,
context:new r((a||0)-m,0,"top",!1),indented:0,startOfLine:!0}},token:function(a,c){var b=c.context;a.sol()&&(null==b.align&&(b.align=!1),c.indented=a.indentation(),c.startOfLine=!0);if(a.eatSpace())return null;f=null;var d=(c.tokenize||h)(a,c);if("comment"==d||"meta"==d)return d;null==b.align&&(b.align=!0);if(";"!=f&&":"!=f||"statement"!=b.type)if("{"==f)l(c,a.column(),"}");else if("["==f)l(c,a.column(),"]");else if("("==f)l(c,a.column(),")");else if("}"==f){for(;"statement"==b.type;)b=k(c);for("}"==
b.type&&(b=k(c));"statement"==b.type;)b=k(c)}else f==b.type?k(c):("}"==b.type||"top"==b.type||"statement"==b.type&&"newstatement"==f)&&l(c,a.column(),"statement");else k(c);c.startOfLine=!1;return d},indent:function(a,c){if(a.tokenize!=h&&null!=a.tokenize)return 0;var b=c&&c.charAt(0),d=a.context,e=b==d.type;return"statement"==d.type?d.indented+("{"==b?0:m):d.align?d.column+(e?0:1):d.indented+(e?0:m)},electricChars:"{}"}});
function words(g){var e={};g=g.split(" ");for(var h=0;h<g.length;++h)e[g[h]]=!0;return e}var glslKeywords="attribute const uniform varying break continue do for while if else in out inout float int void bool true false lowp mediump highp precision invariant discard return mat2 mat3 mat4 vec2 vec3 vec4 ivec2 ivec3 ivec4 bvec2 bvec3 bvec4 sampler2D samplerCube struct gl_FragCoord gl_FragColor",glslBuiltins="radians degrees sin cos tan asin acos atan pow exp log exp2 log2 sqrt inversesqrt abs sign floor ceil fract mod min max clamp mix step smoothstep length distance dot cross normalize faceforward reflect refract matrixCompMult lessThan lessThanEqual greaterThan greaterThanEqual equal notEqual any all not dFdx dFdy fwidth texture2D texture2DProj texture2DLod texture2DProjLod textureCube textureCubeLod require export";
function cppHook(g,e){if(!e.startOfLine)return!1;g.skipToEnd();return"meta"}(function(){CodeMirror.defineMIME("text/x-glsl",{name:"glsl",keywords:words(glslKeywords),builtins:words(glslBuiltins),blockKeywords:words("case do else for if switch while struct"),atoms:words("null"),hooks:{"#":cppHook}})})();
