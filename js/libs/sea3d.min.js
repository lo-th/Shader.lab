...
SEA3D.Stream.prototype.decodeText=function(a){if("undefined"!==typeof TextDecoder)return(new TextDecoder).decode(a);for(var b="",c=0,d=a.length;c<d;c++)b+=String.fromCharCode(a[c]);return decodeURIComponent(escape(b))};SEA3D.Stream.prototype.readUTF8=function(a){a=this.readBytes(a);return this.decodeText(new Uint8Array(a))};SEA3D.Stream.prototype.readExt=function(){return this.readUTF8(4).replace(/\0/g,"")};SEA3D.Stream.prototype.readUTF8Tiny=function(){return this.readUTF8(this.readUByte())};
SEA3D.Stream.prototype.readUTF8Short=function(){return this.readUTF8(this.readUShort())};SEA3D.Stream.prototype.readUTF8Long=function(){return this.readUTF8(this.readUInt())};SEA3D.Stream.prototype.readUByteArray=function(a){var b=new Uint8Array(a);SEA3D.Stream.memcpy(b.buffer,0,this.buffer,this.position,a);this.position+=a;return b};SEA3D.Stream.prototype.readUShortArray=function(a){var b=new Uint16Array(a);a*=2;SEA3D.Stream.memcpy(b.buffer,0,this.buffer,this.position,a);this.position+=a;return b};
SEA3D.Stream.prototype.readUInt24Array=function(a){for(var b=new Uint32Array(a),c=0;c<a;c++)b[c]=this.readUInt24();return b};SEA3D.Stream.prototype.readUIntArray=function(a){var b=new Uint32Array(a);a*=4;SEA3D.Stream.memcpy(b.buffer,0,this.buffer,this.position,a);this.position+=a;return b};SEA3D.Stream.prototype.readFloatArray=function(a){var b=new Float32Array(a);a*=4;SEA3D.Stream.memcpy(b.buffer,0,this.buffer,this.position,a);this.position+=a;return b};SEA3D.Stream.prototype.readBlendMode=function(){return SEA3D.Stream.BLEND_MODE[this.readUByte()]};
SEA3D.Stream.prototype.readInterpolation=function(){return SEA3D.Stream.INTERPOLATION_TABLE[this.readUByte()]};SEA3D.Stream.prototype.readTags=function(a){for(var b=this.readUByte(),c=0;c<b;++c){var d=this.readUShort(),e=this.readUInt(),f=this.position;a(d,this,e);this.position=f+e}};
SEA3D.Stream.prototype.readProperties=function(a){var b=this.readUByte(),c={},d={};c.__type=d;for(var e=0;e<b;e++){var f=this.readUTF8Tiny(),h=this.readUByte();d[f]=h;c[f]=h==SEA3D.Stream.GROUP?this.readProperties(a):this.readToken(h,a)}return c};SEA3D.Stream.prototype.readAnimationList=function(a){for(var b=[],c=this.readUByte(),d=0;d<c;){var e=this.readUByte(),f={};f.relative=0!=(e&1);e&2&&(f.timeScale=this.readFloat());f.tag=a.getObject(this.readUInt());b[d++]=f}return b};
...
((a&64)>>6|(a&128)>>6)+1,this.color=[],a=0;a<c;a++)this.color.push(b.readFloatArray(this.numVertex*this.numColor));this.vertex=b.readFloatArray(this.length);var e=b.readUByte();this.groups=[];if(this.attrib&1024){for(c=a=0;a<e;a++)d=3*b.readVInt(),this.groups.push({start:c,count:d}),c+=d;this.attrib&2048||(this.indexes=this.isBig?b.readUIntArray(c):b.readUShortArray(c))}else{var f=this.isBig?4:2,h=new SEA3D.UByteArray;for(d=a=0;a<e;a++)c=3*b.readVInt(),this.groups.push({start:d,count:c}),d+=c,h.add(b.readUByteArray(c*
f));this.indexes=this.isBig?new Uint32Array(h.toBuffer()):new Uint16Array(h.toBuffer())}};SEA3D.Geometry.prototype=Object.create(SEA3D.GeometryBase.prototype);SEA3D.Geometry.prototype.constructor=SEA3D.Geometry;SEA3D.Geometry.prototype.type="geo";
...
this.depthWrite=0==(this.attrib&256);this.depthTest=0==(this.attrib&512);this.premultipliedAlpha=0!=(this.attrib&1024);a=b.readUByte();for(var d=0;d<a;++d){var e=b.readUShort(),f=b.readUShort(),h=b.position,g,k;switch(e){case SEA3D.Material.PHONG:g={ambientColor:b.readUInt24(),diffuseColor:b.readUInt24(),specularColor:b.readUInt24(),specular:b.readFloat(),gloss:b.readFloat()};break;case SEA3D.Material.PHYSICAL:g={color:b.readUInt24(),roughness:b.readFloat(),metalness:b.readFloat()};break;case SEA3D.Material.ANISOTROPIC:break;
case SEA3D.Material.COMPOSITE_TEXTURE:g={composite:c.getObject(b.readUInt())};break;case SEA3D.Material.DIFFUSE_MAP:case SEA3D.Material.SPECULAR_MAP:case SEA3D.Material.NORMAL_MAP:case SEA3D.Material.AMBIENT_MAP:case SEA3D.Material.ALPHA_MAP:case SEA3D.Material.EMISSIVE_MAP:case SEA3D.Material.ROUGHNESS_MAP:case SEA3D.Material.METALNESS_MAP:g={texture:c.getObject(b.readUInt())};break;case SEA3D.Material.REFLECTION:case SEA3D.Material.FRESNEL_REFLECTION:g={texture:c.getObject(b.readUInt()),alpha:b.readFloat()};
e==SEA3D.Material.FRESNEL_REFLECTION&&(g.power=b.readFloat(),g.normal=b.readFloat());break;case SEA3D.Material.REFRACTION:g={texture:c.getObject(b.readUInt()),alpha:b.readFloat(),ior:b.readFloat()};break;case SEA3D.Material.RIM:g={color:b.readUInt24(),strength:b.readFloat(),power:b.readFloat(),blendMode:b.readBlendMode()};break;case SEA3D.Material.LIGHT_MAP:g={texture:c.getObject(b.readUInt()),channel:b.readUByte(),blendMode:b.readBlendMode()};break;case SEA3D.Material.DETAIL_MAP:g={texture:c.getObject(b.readUInt()),
scale:b.readFloat(),blendMode:b.readBlendMode()};break;case SEA3D.Material.CEL:g={color:b.readUInt24(),levels:b.readUByte(),size:b.readFloat(),specularCutOff:b.readFloat(),smoothness:b.readFloat()};break;case SEA3D.Material.TRANSLUCENT:g={translucency:b.readFloat(),scattering:b.readFloat()};break;case SEA3D.Material.BLEND_NORMAL_MAP:k=b.readUByte();g={texture:c.getObject(b.readUInt()),secondaryTexture:c.getObject(b.readUInt())};k&1?(g.offsetX0=b.readFloat(),g.offsetY0=b.readFloat(),g.offsetX1=b.readFloat(),
g.offsetY1=b.readFloat()):g.offsetX0=g.offsetY0=g.offsetX1=g.offsetY1=0;g.animate=k&2;break;case SEA3D.Material.MIRROR_REFLECTION:g={texture:c.getObject(b.readUInt()),alpha:b.readFloat()};break;case SEA3D.Material.EMISSIVE:g={color:b.readUInt24F()};break;case SEA3D.Material.VERTEX_COLOR:g={blendMode:b.readBlendMode()};break;case SEA3D.Material.WRAP_LIGHTING:g={color:b.readUInt24(),strength:b.readFloat()};break;case SEA3D.Material.COLOR_REPLACE:k=b.readUByte();g={red:b.readUInt24(),green:b.readUInt24(),
blue:b.readUInt24F()};k&1&&(g.mask=c.getObject(b.readUInt()));k&2&&(g.alpha=b.readFloat());break;case SEA3D.Material.REFLECTION_SPHERICAL:g={texture:c.getObject(b.readUInt()),alpha:b.readFloat()};break;case SEA3D.Material.REFLECTIVITY:k=b.readUByte();g={strength:b.readFloat()};k&1&&(g.mask=c.getObject(b.readUInt()));break;case SEA3D.Material.CLEAR_COAT:g={strength:b.readFloat(),roughness:b.readFloat()};break;case SEA3D.Material.FLACCIDITY:k=b.readUByte();g={target:c.getObject(b.readUInt()),scale:b.readFloat(),
spring:b.readFloat(),damping:b.readFloat()};k&1&&(g.mask=c.getObject(b.readUInt()));break;default:console.warn("SEA3D: MaterialTechnique not found:",e.toString(16));b.position=h+f;continue}g.kind=e;this.technique.push(g);this.tecniquesDict[e]=g;b.position=h+f}};SEA3D.Material.PHONG=0;SEA3D.Material.COMPOSITE_TEXTURE=1;SEA3D.Material.DIFFUSE_MAP=2;SEA3D.Material.SPECULAR_MAP=3;SEA3D.Material.REFLECTION=4;SEA3D.Material.REFRACTION=5;SEA3D.Material.NORMAL_MAP=6;SEA3D.Material.FRESNEL_REFLECTION=7;
...
THREE.SEA3D.identityMatrixScale=function(){var a=new THREE.Vector3;return function(b){a.setFromMatrixScale(b);return b.scale(a.set(1/a.x,1/a.y,1/a.z))}}();
...
THREE.SEA3D.prototype.readMesh=function(a){var b,c,d=a.geometry.tag,e,f,h,g,k,m,l;b=0;for(c=a.modifiers?a.modifiers.length:0;b<c;b++){var q=a.modifiers[b];switch(q.type){case SEA3D.Skeleton.prototype.type:case SEA3D.SkeletonLocal.prototype.type:f=q;d.bones=f.tag;break;case SEA3D.Morph.prototype.type:h=q.tag||this.getModifier({sea:q,geometry:a.geometry}),d.morphAttributes=h.attribs,d.morphTargets=h.targets}}b=0;for(c=a.animations?a.animations.length:0;b<c;b++)switch(q=a.animations[b].tag,q.type){case SEA3D.SkeletonAnimation.prototype.type:g=
q;d.animations=g.tag||this.getModifier({sea:g,skeleton:f,relative:!0});break;case SEA3D.VertexAnimation.prototype.type:k=q;d.morphAttributes=k.tag.attribs;d.morphTargets=k.tag.targets;d.animations=k.tag.animations;break;case SEA3D.UVWAnimation.prototype.type:m=q.tag||this.getModifier({sea:q});break;case SEA3D.MorphAnimation.prototype.type:l=q.tag||this.getModifier({sea:q})}c=void 0!=h||void 0!=k;h=h&&void 0!=h.attribs.normal||k&&void 0!=k.tag.attribs.normal;if(a.material)if(1<a.material.length)for(q=
[],b=0;b<a.material.length;b++)q[b]=a.material[b].tag,q[b].skinning=void 0!=f,q[b].morphTargets=c,q[b].morphNormals=h,q[b].vertexColors=a.geometry.color?THREE.VertexColors:THREE.NoColors;else e=a.material[0].tag,e.skinning=void 0!=f,e.morphTargets=c,e.morphNormals=h,e.vertexColors=a.geometry.color?THREE.VertexColors:THREE.NoColors;f?(b=new THREE.SEA3D.SkinnedMesh(d,e,this.config.useVertexTexture),this.config.autoPlay&&g&&b.play(0)):k?(b=new THREE.SEA3D.VertexAnimationMesh(d,e),this.config.autoPlay&&
b.play(0)):b=new THREE.SEA3D.Mesh(d,e);m&&(b.uvwAnimator=new THREE.SEA3D.Animator(m,new THREE.AnimationMixer(e.map)),this.config.autoPlay&&b.uvwAnimator.play(0));l&&(b.morphAnimator=new THREE.SEA3D.Animator(l,new THREE.AnimationMixer(b)),this.config.autoPlay&&b.morphAnimator.play(0));b.name=a.name;b.castShadow=a.castShadows;b.receiveShadow=a.material?a.material[0].receiveShadows:!0;this.domain.meshes=this.meshes=this.meshes||[];this.meshes.push(this.objects["m3d/"+a.name]=a.tag=b);this.addSceneObject(a);
this.updateTransform(b,a);this.addDefaultAnimation(a,THREE.SEA3D.Object3DAnimator)};
...
THREE.SEA3D.prototype.readCubeMap=function(a){var b=this.toFaces(a.faces),c=new THREE.CubeTexture([]),d=0;c.name=a.name;c.flipY=!1;c.format=THREE.RGBFormat;for(var e=function(){6==++d&&(c.needsUpdate=!0,this.config.async||(this.file.resume=!0))}.bind(this),f=0;f<b.length;++f){var h=new Image;h.onload=e;h.src=this.createObjectURL(b[f].buffer,"image/"+a.extension);c.images[f]=h}this.config.async||(this.file.resume=!1);this.domain.cubemaps=this.cubemaps=this.cubemaps||[];this.cubemaps.push(this.objects["cmap/"+
...
THREE.SEA3D.prototype.readAnimation=function(a){for(var b=[],c=1E3/a.frameRate/1E3,d=0;d<a.sequence.length;d++){for(var e=a.sequence[d],f=[],h=0;h<a.dataList.length;h++){var g=a.dataList[h],k,m,l,q=g.data;l=e.start*g.blockSize;k=l+e.count*g.blockSize;var s=e.intrpl?THREE.InterpolateLinear:!1,r=null;switch(g.kind){case SEA3D.Animation.POSITION:r=".position";break;case SEA3D.Animation.ROTATION:r=".quaternion";break;case SEA3D.Animation.SCALE:r=".scale";break;case SEA3D.Animation.COLOR:r=".color";break;
case SEA3D.Animation.MULTIPLIER:r=".intensity";break;case SEA3D.Animation.FOV:r=".fov";break;case SEA3D.Animation.OFFSET_U:r=".offset[x]";break;case SEA3D.Animation.OFFSET_V:r=".offset[y]";break;case SEA3D.Animation.SCALE_U:r=".repeat[x]";break;case SEA3D.Animation.SCALE_V:r=".repeat[y]";break;case SEA3D.Animation.RADIAN:r=".rotation";break;case SEA3D.Animation.MORPH:r=".morphTargetInfluences["+g.name+"]"}if(r)switch(g.type){case SEA3D.Stream.BYTE:case SEA3D.Stream.UBYTE:case SEA3D.Stream.INT:case SEA3D.Stream.UINT:case SEA3D.Stream.FLOAT:case SEA3D.Stream.DOUBLE:case SEA3D.Stream.DECIMAL:l=
q.subarray(l,k);m=new Float32Array(l.length);for(k=g=0;k<m.length;k++)m[k]=g,g+=c;f.push(new THREE.NumberKeyframeTrack(r,m,l,s));break;case SEA3D.Stream.VECTOR3D:l=q.subarray(l,k);m=new Float32Array(l.length/g.blockSize);for(k=g=0;k<m.length;k++)m[k]=g,g+=c;f.push(new THREE.VectorKeyframeTrack(r,m,l,s));break;case SEA3D.Stream.VECTOR4D:l=q.subarray(l,k);m=new Float32Array(l.length/g.blockSize);for(k=g=0;k<m.length;k++)m[k]=g,g+=c;f.push(new THREE.QuaternionKeyframeTrack(r,m,l,s));break;case SEA3D.Stream.INT24:case SEA3D.Stream.UINT24:l=
new Float32Array(3*(k-l));m=new Float32Array(l.length/3);for(k=g=0;k<m.length;k++)l[3*k]=(q[k]>>16&255)/255,l[3*k+1]=(q[k]>>8&255)/255,l[3*k+2]=(q[k]&255)/255,m[k]=g,g+=c;f.push(new THREE.VectorKeyframeTrack(r,m,l,s))}}b.push(new THREE.SEA3D.AnimationClip(e.name,-1,f,e.repeat))}this.domain.clips=this.clips=this.clips||[];this.clips.push(this.objects[a.name+".anm"]=a.tag=b)};
THREE.SEA3D.prototype.readSkeletonAnimation=function(a,b){b=!b&&a.metadata&&a.metadata.skeleton?a.metadata.skeleton:b;if(!b||a.tag)return a.tag;for(var c=[],d=1E3/a.frameRate/1E3,e=0;e<a.sequence.length;e++){for(var f=a.sequence[e],h=f.start,g=h+f.count,k={name:f.name,fps:a.frameRate,length:d*f.count,hierarchy:[]},m=a.numJoints,l=a.raw,q=0;q<m;q++){for(var s={parent:b.joint[q].parentIndex,keys:[]},r=s.keys,t=0,p=h;p<g;p++){var n=p*m*7+7*q;r.push({time:t,pos:[l[n],l[n+1],l[n+2]],rot:[l[n+3],l[n+4],
l[n+5],l[n+6]],scl:[1,1,1]});t+=d}k.hierarchy[q]=s}c.push(THREE.SEA3D.AnimationClip.fromClip(THREE.AnimationClip.parseAnimation(k,b.tag),f.repeat))}this.domain.clips=this.clips=this.clips||[];this.clips.push(this.objects[a.name+".skla"]=a.tag=c)};
...
a.frameRate),h.repeat))}a.tag={attribs:b,targets:c,animations:d};this.domain.clips=this.clips=this.clips||[];this.clips.push(this.objects[a.name+".vtxa"]=a.tag)};
...
THREE.SEA3D.prototype.degToRadAnimation=function(a){if(!a.isRadians){for(var b=a.dataList,c=0;c<b.length;c++){var d=b[c];if(d.kind===SEA3D.Animation.DEGREE){d.kind=SEA3D.Animation.RADIAN;for(var e=0;e<d.data.length;e++)d.data[e]*=SEA3D.Math.DEG_TO_RAD}}a.isRadians=!0}};
THREE.SEA3D.prototype.flipDefaultAnimation=function(){var a=new THREE.Matrix4,b=new THREE.Matrix4,c=new THREE.Vector3,d=new THREE.Quaternion,e=new THREE.Vector3,f=new THREE.Vector3,h=new THREE.Quaternion,g=new THREE.Vector3;return function(k,m,l){if(!k.isFliped){for(var q=k.dataList,s=[],r=0;r<q.length;r++){var t=q[r],p=t.data,n=t.kind,t=p.length/t.blockSize;switch(n){case SEA3D.Animation.POSITION:case SEA3D.Animation.ROTATION:case SEA3D.Animation.SCALE:s.push({kind:n,numFrames:t,raw:p})}}if(0<s.length)for(t=
s[0].numFrames,p=void 0,l?(a.identity(),this.flipScaleMatrix(b.copy(m.matrixWorld))):(m.parent&&(p=this.flipScaleMatrix(b.copy(m.parent.matrixWorld))),this.flipScaleMatrix(a.copy(m.matrix),!1,p)),a.decompose(c,d,e),m=0;m<t;m++){for(l=0;l<s.length;l++)switch(p=s[l].raw,n=s[l].kind,n){case SEA3D.Animation.POSITION:n=3*m;c.set(p[n],p[n+1],p[n+2]);break;case SEA3D.Animation.ROTATION:n=4*m;d.set(p[n],p[n+1],p[n+2],p[n+3]);break;case SEA3D.Animation.SCALE:n=4*m,e.set(p[n],p[n+1],p[n+2])}a.compose(c,d,e);
this.flipScaleMatrix(a,!1,b);a.decompose(f,h,g);for(l=0;l<s.length;l++)switch(p=s[l].raw,n=s[l].kind,n){case SEA3D.Animation.POSITION:n=3*m;p[n]=f.x;p[n+1]=f.y;p[n+2]=f.z;break;case SEA3D.Animation.ROTATION:n=4*m;p[n]=h.x;p[n+1]=h.y;p[n+2]=h.z;p[n+3]=h.w;break;case SEA3D.Animation.SCALE:n=3*m,p[n]=g.x,p[n+1]=g.y,p[n+2]=g.z}}k.isFliped=!0}}}();THREE.SEA3D.prototype.readAnimation=function(a){this.isLegacy(a)||this._readAnimation(a)};
THREE.SEA3D.prototype.getModifier=function(a){var b=a.sea;if(this.isLegacy(b)&&!b.done)switch(b.done=!0,b.type){case SEA3D.SkeletonAnimation.prototype.type:return this.readSkeletonAnimationLegacy(b,a.skeleton),b.tag;case SEA3D.Animation.prototype.type:case SEA3D.MorphAnimation.prototype.type:return a.scope instanceof THREE.Object3D&&this.flipDefaultAnimation(b,a.scope,a.relative),this._readAnimation(b),b.tag;case SEA3D.UVWAnimation.prototype.type:return this.degToRadAnimation(b),this._readAnimation(b),
b.tag;case SEA3D.Morph.prototype.type:this.readMorphLegacy(b,a.geometry)}return this._getModifier(a)};
...
THREE.SEA3D.prototype.readSkeleton=function(){var a=new THREE.Matrix4,b=new THREE.Matrix4,c=new THREE.Matrix4,d=new THREE.Vector3,e=new THREE.Quaternion;return function(f){for(var h=[],g=f.sea3d.config.legacy,k=0;k<f.joint.length;k++){var m=f.joint[k];a.fromArray(m.inverseBindMatrix);b.getInverse(a);g&&this.flipBoneMatrix(b);-1<m.parentIndex&&(a.fromArray(f.joint[m.parentIndex].inverseBindMatrix),c.getInverse(a),g&&this.flipBoneMatrix(c),c.getInverse(c),b.multiplyMatrices(c,b));d.setFromMatrixPosition(b);
e.setFromRotationMatrix(b);h[k]={name:m.name,pos:[d.x,d.y,d.z],rotq:[e.x,e.y,e.z,e.w],parent:m.parentIndex}}this.domain.bones=this.bones=this.bones||[];this.bones.push(this.objects[f.name+".sklq"]=f.tag=h);return h}}();
THREE.SEA3D.prototype.readSkeletonAnimationLegacy=function(){var a=new THREE.Matrix4,b=new THREE.Matrix4,c=new THREE.Matrix4,d=new THREE.Matrix4;return function(e,f){if(e.tag)return e.tag;for(var h=[],g=1E3/e.frameRate/1E3,k=[1,1,1],m=0;m<e.sequence.length;m++){for(var l=e.sequence[m],q=l.start,s=q+l.count,r={name:l.name,repeat:l.repeat,fps:e.frameRate,JIT:0,length:g*l.count,hierarchy:[]},t=e.numJoints,p=e.raw,n=0;n<t;n++){for(var w=f.joint[n],z={parent:w.parentIndex,keys:[]},A=z.keys,x=0,y=q;y<s;y++){var u=
y*t*7+7*n;b.makeRotationFromQuaternion(THREE.SEA3D.QUABUF.set(p[u+3],p[u+4],p[u+5],p[u+6]));b.setPosition(THREE.SEA3D.VECBUF.set(p[u],p[u+1],p[u+2]));-1<w.parentIndex?(a.fromArray(f.joint[w.parentIndex].inverseBindMatrix),d.getInverse(a),c.multiplyMatrices(d,b),this.flipBoneMatrix(c),this.flipBoneMatrix(d),d.getInverse(d),b.multiplyMatrices(d,c)):this.flipBoneMatrix(b);var u=THREE.SEA3D.VECBUF.setFromMatrixPosition(b),v=THREE.SEA3D.QUABUF.setFromRotationMatrix(b);A.push({time:x,pos:[u.x,u.y,u.z],
rot:[v.x,v.y,v.z,v.w],scl:k});x+=g}r.hierarchy[n]=z}h.push(THREE.SEA3D.AnimationClip.fromClip(THREE.AnimationClip.parseAnimation(r,f.tag),l.repeat))}this.domain.clips=this.clips=this.clips||[];this.clips.push(this.objects[e.name+".anm"]=e.tag=h)}}();THREE.SEA3D.prototype.readMorphLegacy=function(a,b){for(var c=0;c<a.node.length;c++){var d=a.node[c];this.flipVec3(d.vertex);this.flipVec3(d.normal);this.addVector(d.vertex,b.vertex);this.addVector(d.normal,b.normal)}this._readMorph(a)};
