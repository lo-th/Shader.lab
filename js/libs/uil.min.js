...
UIL.Bool.prototype.update=function(){var a=this.s;this.value?(a[4].marginLeft="18px",a[2].background=this.fontColor,a[2].borderColor=this.fontColor,a[4].borderColor=this.fontColor):(a[4].marginLeft="0px",a[2].background=UIL.BOOLBG,a[2].borderColor=UIL.BOOLBG,a[4].borderColor=UIL.Border)};UIL.Button=function(a){UIL.Proto.call(this,a);this.value=a.value||[this.txt];this.buttonColor=a.bColor||UIL.BUTTON;this.isLoadButton=a.loader||!1;if(this.isDragButton=a.drag||!1)this.isLoadButton=!0;this.r=a.r||0;this.lng=this.value.length;for(a=0;a<this.lng;a++)this.c[a+2]=UIL.DOM(null,"div",UIL.TXT+UIL.BASIC+"text-align:center; border:1px solid "+UIL.Border+"; top:1px; pointer-events:auto; cursor:pointer; background:"+this.buttonColor+"; height:"+(this.h-2)+"px; border-radius:"+this.r+"px; line-height:"+
(this.h-4)+"px;"),this.c[a+2].style.color=this.fontColor,this.c[a+2].events=["click","mouseover","mousedown","mouseup","mouseout"],this.c[a+2].innerHTML=this.value[a],this.c[a+2].name=a;void 0!==this.c[1]&&(this.c[1].textContent="");this.isLoadButton&&this.initLoader();this.isDragButton&&this.initDrager();this.init()};UIL.Button.prototype=Object.create(UIL.Proto.prototype);UIL.Button.prototype.constructor=UIL.Button;
...
"vector-effect":"non-scaling-stroke"},this.c[2]);this.c[3]=UIL.DOM(null,"div",UIL.BASIC+"width:100%; bottom:0px; height:1px; background: rgba(255, 255, 255, 0.2);");this.isShow=a.show||!1;this.now=self.performance&&self.performance.now?self.performance.now.bind(performance):Date.now;this.prevTime=this.startTime=this.now();this.frames=0;this.isMem=!1;this.mm=this.mem=this.fps=this.ms=0;self.performance&&self.performance.memory&&(this.isMem=!0);this.c[0].events=["click","mousedown","mouseover","mouseout"];
this.init()};UIL.Fps.prototype=Object.create(UIL.Proto.prototype);UIL.Fps.prototype.constructor=UIL.Fps;UIL.Fps.prototype.handleEvent=function(a){a.preventDefault();switch(a.type){case "click":this.click(a);break;case "mouseover":this.mode(1);break;case "mousedown":this.mode(2);break;case "mouseout":this.mode(0)}};UIL.Fps.prototype.click=function(a){this.isShow?this.hide():this.show()};
UIL.Fps.prototype.mode=function(a){var b=this.s;switch(a){case 0:b[1].color=this.fontColor;b[1].background="none";break;case 1:b[1].color="#FFF";b[1].background=UIL.SELECT;break;case 2:b[1].color=this.fontColor,b[1].background=UIL.SELECTDOWN}};UIL.Fps.prototype.makePath=function(a){var b;b="M -1 50";for(var c=0;c<this.res+1;c++)b+=" L "+c+" "+a[c];return b+=" L "+(this.res+1)+" 50"};
...
UIL.Fps.prototype.show=function(){this.h=this.hplus+this.baseH;null!==this.parentGroup?this.parentGroup.calc(this.hplus):this.isUI&&this.main.calc(this.hplus);this.s[0].height=this.h+"px";this.s[2].display="block";this.isShow=!0;UIL.addListen(this)};
UIL.Fps.prototype.hide=function(){this.h=this.baseH;null!==this.parentGroup?this.parentGroup.calc(-this.hplus):this.isUI&&this.main.calc(-this.hplus);this.s[0].height=this.h+"px";this.s[2].display="none";this.isShow=!1;UIL.removeListen(this);this.c[1].textContent="FPS"};UIL.Fps.prototype.rSize=function(){this.s[0].width=this.width+"px";this.s[1].width=this.width+"px";this.s[2].left="10px";this.s[2].width=this.width-20+"px"};UIL.Fps.prototype.begin=function(){this.startTime=this.now()};
