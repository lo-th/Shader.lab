...
"100%");b="data:image/svg+xml;base64,"+window.btoa((new XMLSerializer).serializeToString(b));a=null;f.src=b;setTimeout(function(){e.clearRect(0,0,c,d);e.drawImage(f,0,0,c,d,0,0,c,d)},0)};return UMC}();var define,module,exports,performance,UIL=function(){UIL={REVISION:1,frag:UMC.frag,DOM:UMC.dom,clear:UMC.clear,setSvg:UMC.setSvg,isLoop:!1,listens:[],main:null,DEF:!1,WIDTH:240,HEIGHT:20,P:30,BASIC:"-o-user-select:none; -ms-user-select:none; -khtml-user-select:none; -webkit-user-select:none; -moz-user-select:none; position:absolute; pointer-events:none; box-sizing:border-box; margin:0; padding:0; border:none; overflow:hidden; background:none;",COLOR:"N",BASECOLOR:"#C0C0C0",BUTTON:"#404040",BOOLBG:"#181818",
SELECT:"#035fcf",MOVING:"#03afff",SELECTDOWN:"#024699",BG:"rgba(0,0,0,0.3)",SVGB:"rgba(0,0,0,0.3)",SVGC:"rgba(120,120,120,0.6)",Border:"#4f4f4f",BorderSelect:"#035fcf",PNG:"url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAA",PNGP:"oAAAAKAgMAAADwXCcuAAAACVBMVEVMaXHi4uLi4uLDusitAAAAAnRSTlMAgJsrThgAAAA",setText:function(a,b,c){UIL.TXT=UIL.BASIC+"font-family:"+(c||'"Consolas", "Lucida Console", Monaco, monospace')+"; font-size:"+(a||11)+"px; color:"+(b||"#CCC")+"; padding:2px 10px; left:0; top:2px; height:16px; width:100px; overflow:hidden; white-space: nowrap;";
UIL.TXTSELECT=UIL.TXT+"pointer-events:auto; padding:2px 5px; outline:none; -webkit-appearance:none; -moz-appearance:none; border:1px dashed "+UIL.Border+"; -ms-user-select:element;";UIL.NUM=UIL.TXT+"letter-spacing:-1px; padding:2px 5px;";UIL.ITEM=UIL.TXT+"position:relative; background:rgba(0,0,0,0.2); margin-bottom:1px; pointer-events:auto; cursor:pointer;"}};UIL.GroupBG=UIL.PNG+"MAAAADAQMAAABs5if8AAAABlBMVEVMaXH///+a4ocPAAAAAnRSTlMAM8lDrC4AAAAOSURBVHicY2BgcGBgAAAAxgBBOTEMSwAAAABJRU5ErkJggg==)";UIL.SlideBG=
UIL.PNG+"UAAAAFAQMAAAC3obSmAAAABlBMVEVMaXH///+a4ocPAAAAAnRSTlMAM8lDrC4AAAASSURBVHicY3BgaGDgYBBgUAAABkIA+fbHMRYAAAAASUVORK5CYII=)";UIL.SlideBG_NN=UIL.PNG+"UAAAAFCAYAAACNbyblAAAALElEQVQImV3MsQ0AIAwDwUsmYTRGyeg0SAi7eekKF8bbwu4ETCdAJ0Ddfr8H+wEEqTj7jz0AAAAASUVORK5CYII=)";UIL.F0=UIL.PNG+UIL.PNGP+"kSURBVHicY2BkYGBgc2BgYJwAZKSwMDBIckIwkA0SA8sxMAAAN24CxaaVoKMAAAAASUVORK5CYII=)";UIL.F1=UIL.PNG+UIL.PNGP+"kSURBVHicY2CAAgEGB4YUxokMkmxuDGyRnAyMS1gYGAJgsgwAPlADDRCT8ZwAAAAASUVORK5CYII=)";UIL.X0=UIL.PNG+UIL.PNGP+
"lSURBVHicYxBgcGBIYZzIIMnmxsAWycnAuIQFjEFskBhIDqgGAGxoBXlOWpMvAAAAAElFTkSuQmCC)";UIL.setText();return UIL}();(function(a){"function"===typeof define&&define.amd?define("uil",UIL):"undefined"!==typeof exports&&"undefined"!==typeof module?module.exports=UIL:a.UIL=UIL})(this);UIL.loop=function(){UIL.isLoop&&requestAnimationFrame(UIL.loop);UIL.update()};UIL.update=function(){for(var a=UIL.listens.length;a--;)UIL.listens[a].listening()};UIL.removeListen=function(a){a=UIL.listens.indexOf(a);UIL.listens.splice(a,1);0===UIL.listens.length&&(UIL.isLoop=!1)};UIL.addListen=function(a){-1===UIL.listens.indexOf(a)&&(UIL.listens.push(a),UIL.isLoop||(UIL.isLoop=!0,UIL.loop()))};
...
this.width+"px";this.isCenter&&(this.content.style.marginLeft=-~~(0.5*this.width)+"px");for(var b=a=this.uis.length;b--;)this.uis[b].setSize(this.width);for(b=a;b--;)this.uis[b].rSize();this.resize()}};UIL.Proto=function(a){a=a||{};this.main=a.main||null;this.p=a.p||a.tPercent||0;this.autoWidth=!0;this.isGroup=!1;this.parentGroup=null;this.autoHeight=!1;this.isUI=a.isUI||!1;this.isEdit=this.mono=this.isNumber=!1;this.simple=a.simple||!1;this.width=this.isUI?this.main.width:UIL.WIDTH;void 0!==a.width&&(this.width=a.width);void 0!==a.size&&(this.width=a.size);this.setSize(this.width);void 0!==a.sa&&(this.sa=a.sa);void 0!==a.sb&&(this.sb=a.sb);this.sc=void 0===a.sc?47:a.sc;this.val=this.parent=null;
this.isSend=!1;var b=20;this.isUI&&(b=UIL.HEIGHT);this.h=a.h||a.height||b;this.h=11>this.h?11:this.h;this.bgcolor=UIL.COLOR||a.bgcolor;this.bg=this.isUI?this.main.bg:"rgba(44,44,44,0.3)";void 0!==a.bg&&(this.bg=a.bg);this.titleColor=a.titleColor||UIL.BASECOLOR;this.fontColor=a.fontColor||UIL.BASECOLOR;this.colorPlus=UIL.ColorLuma(this.fontColor,0.3);this.txt=a.name||"Proto";this.rename=a.rename||"";this.target=a.target||null;this.callback=void 0===a.callback?null:a.callback;this.endCallback=null;
null===this.callback&&this.isUI&&null!==this.main.callback&&(this.callback=this.main.callback);this.c=[];this.s=[];this.c[0]=UIL.DOM(null,"div",UIL.BASIC+"position:relative; height:20px; float:left;");this.s[0]=this.c[0].style;this.isUI&&(this.s[0].marginBottom="1px");this.simple||(this.c[1]=UIL.DOM(null,"div",UIL.TXT),this.s[1]=this.c[1].style,this.c[1].textContent=""===this.rename?this.txt:this.rename,this.s[1].color=this.titleColor);if(a.pos){this.s[0].position="absolute";for(var c in a.pos)this.s[0][c]=
a.pos[c];this.mono=!0}a.css&&(this.s[0].cssText=a.css)};
...
document.body.removeChild(this.c[0]);this.target=this.callback=this.s=this.c=null},setSize:function(a){this.autoWidth&&(this.width=a,this.p||(this.p=UIL.P),this.simple?(this.sa=0,this.sb=this.width):(a=this.p/100*this.width,this.sa=~~a,this.sb=~~this.width-a-10))},rSize:function(){this.autoWidth&&(this.s[0].width=this.width+"px",this.simple||(this.s[1].width=this.sa+"px"))},setTypeNumber:function(a){this.isNumber=!0;this.value=0;void 0!==a.value&&(this.value="string"===typeof a.value?1*a.value:a.value);
...
this.c[a],void 0!==c&&void 0!==c.events)for(b=c.events.length;b--;)c.addEventListener(c.events[b],this,!1)},clearEvent:function(){for(var a=this.c.length,b,c;a--;)if(c=this.c[a],void 0!==c&&void 0!==c.events)for(b=c.events.length;b--;)c.removeEventListener(c.events[b],this,!1)},handleEvent:function(a){},setReferency:function(a,b){this.parent=a;this.val=b},display:function(a){this.s[0].display=a?"block":"none"}};UIL.Group=function(a){UIL.Proto.call(this,a);this.isGroup=this.autoHeight=!0;this.baseH=this.h;this.isOpen=a.open||!1;this.c[2]=UIL.DOM(null,"div",UIL.BASIC+"width:100%; left:0; height:auto; top:"+this.h+"px");this.c[3]=UIL.DOM(null,"div",UIL.BASIC+"top:2px; left:2px; height:"+(this.h-4)+"px; width:6px; background-image:"+UIL.GroupBG);this.c[4]=UIL.DOM(null,"div",UIL.BASIC+"position:absolute; width:10px; height:10px; top:"+(~~(0.5*this.h)-5)+"px; pointer-events:none; background:"+UIL.F0);a.line&&
(this.c[5]=UIL.DOM(null,"div",UIL.BASIC+"background:"+this.fontColor+"; width:100%; left:0; height:1px; bottom:0px"));var b=this.s;b[0].height=this.h+"px";b[1].height=this.h+"px";b[1].top="4px";b[1].left="4px";b[1].pointerEvents="auto";b[1].cursor="pointer";this.c[1].name="group";this.s[1].color=this.fontColor;this.s[1].fontWeight="bold";this.uis=[];this.c[1].events=["click"];this.init();void 0!==a.bg&&this.setBG(a.bg);this.isOpen&&this.open()};UIL.Group.prototype=Object.create(UIL.Proto.prototype);
UIL.Group.prototype.constructor=UIL.Group;UIL.Group.prototype.setBG=function(a){this.s[0].background=a;for(var b=this.uis.length;b--;)this.uis[b].setBG(a)};UIL.Group.prototype.handleEvent=function(a){a.preventDefault();switch(a.type){case "click":this.click(a)}};UIL.Group.prototype.click=function(a){this.isOpen?this.close():this.open()};
UIL.Group.prototype.add=function(){var a=arguments;"object"===typeof a[1]?(a[1].isUI=this.isUI,a[1].target=this.c[2]):"string"===typeof arguments[1]&&(void 0===a[2]?[].push.call(a,{isUI:!0,target:this.c[2]}):(a[2].isUI=!0,a[2].target=this.c[2]));a=UIL.Gui.prototype.add.apply(this,a);a.autoHeight&&(a.parentGroup=this);return a};UIL.Group.prototype.open=function(){this.isOpen=!0;this.s[4].background=UIL.F1;this.rSizeContent();this.isUI&&this.main.calc(this.h-this.baseH)};
UIL.Group.prototype.close=function(){this.isUI&&this.main.calc(-(this.h-this.baseH));this.isOpen=!1;this.s[4].background=UIL.F0;this.h=this.baseH;this.s[0].height=this.h+"px"};UIL.Group.prototype.clear=function(){this.clearGroup();this.isUI&&this.main.calc(-(this.h+1));UIL.Proto.prototype.clear.call(this)};UIL.Group.prototype.clearGroup=function(){this.close();for(var a=this.uis.length;a--;)this.uis[a].clear(),this.uis.pop();this.uis=[];this.h=this.baseH};
...
UIL.Slide.prototype.mode=function(a){var b=this.s;switch(a){case 0:b[2].color=this.fontColor;b[4].background="rgba(0,0,0,0.3)";b[5].background=this.fontColor;break;case 1:b[2].color=this.colorPlus,b[4].background=b[6]?"rgba(0,0,0,0.6)":UIL.SlideBG,b[5].background=this.colorPlus}};UIL.Slide.prototype.over=function(a){a.preventDefault();a.stopPropagation();this.isOver=!0;this.mode(1)};UIL.Slide.prototype.out=function(a){a.preventDefault();a.stopPropagation();this.isOver=!1;this.isDown||this.mode(0)};
...
UIL.Slide.prototype.blur=function(a){a.target.style.border="none";this.isEdit=a.target.contentEditable=!1};UIL.Slide.prototype.focus=function(a){a.target.style.border="1px dashed "+UIL.BorderSelect};UIL.List=function(a){UIL.Proto.call(this,a);this.autoHeight=!0;var b=a.align||"center";this.buttonColor=UIL.BUTTON;this.c[2]=UIL.DOM(null,"div",UIL.BASIC+"box-sizing:content-box; border:20px solid transparent; border-bottom:10px solid transparent top:0px; height:90px; cursor:s-resize; pointer-events:auto; display:none;");this.c[3]=UIL.DOM(null,"div",UIL.BASIC+"border:1px solid "+UIL.Border+"; top:1px; pointer-events:auto; cursor:pointer; background:"+this.buttonColor+"; height:"+(this.h-2)+"px;");
this.c[4]=UIL.DOM(null,"div",UIL.BASIC+"position:absolute; width:10px; height:10px; left:"+(this.sa+this.sb-5)+"px; top:"+(~~(0.5*this.h)-5)+"px; background:"+UIL.F0);this.c[5]=UIL.DOM(null,"div",UIL.TXT+"text-align:"+b+"; height:"+(this.h-4)+"px; line-height:"+(this.h-8)+"px;");this.c[6]=UIL.DOM(null,"div",UIL.BASIC+"right:14px; top:"+this.h+"px; height:16px; width:10px; pointer-events:none; background:#666; display:none;");this.c[2].name="list";this.c[3].name="title";this.c[2].style.borderTop=this.h+
"px solid transparent";this.c[5].style.color=this.fontColor;this.c[2].events="mousedown mousemove mouseup mouseout mousewheel mouseover".split(" ");this.c[3].events=["click","mousedown","mouseover","mouseout"];this.list=a.list||[];a.value?isNaN(a.value)?this.value=a.value:this.value=this.list[a.value]:this.value=this.list[0];this.baseH=this.h;this.isShow=!1;this.maxItem=a.maxItem||5;this.itemHeight=a.itemHeight||this.h-3;this.length=this.list.length;if(this.full=a.full||!1)this.maxItem=this.length;
this.maxHeight=this.maxItem*(this.itemHeight+1);this.max=this.length*(this.itemHeight+1);this.ratio=this.maxHeight/this.max;this.sh=this.maxHeight*this.ratio;this.range=this.maxHeight-this.sh;this.c[6].style.height=this.sh+"px";this.py=0;this.w=this.sb;this.isDown=this.scroll=!1;this.side=a.side||"down";this.holdTop=0;"up"===this.side&&(this.c[2].style.top="auto",this.c[3].style.top="auto",this.c[4].style.top="auto",this.c[5].style.top="auto",this.c[2].style.bottom="10px",this.c[3].style.bottom="2px",
this.c[4].style.bottom="2px",this.c[5].style.bottom="2px");this.max>this.maxHeight&&(this.w=this.sb-20,this.scroll=!0);this.listIn=UIL.DOM(null,"div",UIL.BASIC+"left:0; top:0; width:100%; background:rgba(0,0,0,0.2); ");this.listIn.name="list";this.c[2].style.height=this.maxHeight+"px";this.c[2].appendChild(this.listIn);for(var c=0;c<this.length;c++)b=this.list[c],a=UIL.DOM(null,"div",UIL.ITEM+"width:"+this.w+"px; height:"+this.itemHeight+"px; line-height:"+(this.itemHeight-5)+"px;"),a.textContent=
b,a.style.color=this.fontColor,a.name="item",this.listIn.appendChild(a);this.c[5].textContent=this.value;this.init()};UIL.List.prototype=Object.create(UIL.Proto.prototype);UIL.List.prototype.constructor=UIL.List;
...
UIL.List.prototype.mode=function(a){var b=this.s;switch(a){case 0:b[5].color=this.fontColor;b[3].background=this.buttonColor;break;case 1:b[5].color="#FFF";b[3].background=UIL.SELECT;break;case 2:b[5].color=this.fontColor,b[3].background=UIL.SELECTDOWN}};UIL.List.prototype.click=function(a){this.isShow?this.listHide():this.listShow()};UIL.List.prototype.listover=function(a){"item"===a.target.name&&(a.target.style.background=UIL.SELECT,a.target.style.color="#FFF")};
UIL.List.prototype.listdown=function(a){var b=a.target.name;"list"!==b&&void 0!==b?(this.value=a.target.textContent,this.c[5].textContent=this.value,this.send(),this.listHide()):"list"===b&&this.scroll&&(this.isDown=!0,this.listmove(a),this.listIn.style.background="rgba(0,0,0,0.6)",this.s[6].background="#AAA",a.preventDefault())};UIL.List.prototype.listmove=function(a){if(this.isDown){var b=this.c[2].getBoundingClientRect();this.update(a.clientY-b.top-this.baseH-0.5*this.sh)}};
UIL.List.prototype.listup=function(a){this.isDown=!1;this.listIn.style.background="rgba(0,0,0,0.2)";this.s[6].background="#666"};UIL.List.prototype.listout=function(a){"item"===a.target.name&&(a.target.style.background="rgba(0,0,0,0.2)",a.target.style.color=this.fontColor);this.isUI&&(this.main.lockwheel=!1);this.listup();void 0===a.relatedTarget.name&&this.listHide()};
UIL.List.prototype.listwheel=function(a){if(this.scroll){this.isUI&&(this.main.lockwheel=!0);var b=0;a.wheelDeltaY?b=0.04*-a.wheelDeltaY:a.wheelDelta?b=0.2*-a.wheelDelta:a.detail&&(b=4*a.detail);this.py+=b;this.update(this.py)}};UIL.List.prototype.update=function(a){this.scroll&&(a=0>a?0:a,a=a>this.range?this.range:a,this.listIn.style.top=-~~(a/this.ratio)+"px",this.s[6].top=~~a+this.baseH+"px",this.py=a)};
UIL.List.prototype.listShow=function(){this.update(0);this.isShow=!0;this.h=this.maxHeight+this.baseH+10;this.scroll?this.s[6].display="block":(this.h=this.baseH+10+this.max,this.s[6].display="none",this.c[2].removeEventListener("mousewheel",this,!1),this.c[2].removeEventListener("mousemove",this,!1));this.s[0].height=this.h+"px";this.s[2].display="block";this.s[4].background="up"===this.side?UIL.F0:UIL.F1;this.rSizeContent();null!==this.parentGroup?this.parentGroup.calc(this.h-this.baseH):this.isUI&&
this.main.calc(this.h-this.baseH)};UIL.List.prototype.listHide=function(){null!==this.parentGroup?this.parentGroup.calc(-(this.h-this.baseH)):this.isUI&&this.main.calc(-(this.h-this.baseH));this.isShow=!1;this.h=this.baseH;this.s[0].height=this.h+"px";this.s[2].display="none";this.s[4].background=UIL.F0};UIL.List.prototype.text=function(a){this.c[5].textContent=a};UIL.List.prototype.rSizeContent=function(){for(var a=this.length;a--;)this.listIn.children[a].style.width=this.w+"px"};
UIL.List.prototype.rSize=function(){UIL.Proto.prototype.rSize.call(this);var a=this.s;a[2].width=this.sb+"px";a[2].left=this.sa-20+"px";a[3].width=this.sb+"px";a[3].left=this.sa+"px";a[4].left=this.sa+this.sb-17+"px";a[5].width=this.sb+"px";a[5].left=this.sa+"px";this.w=this.sb;this.max>this.maxHeight&&(this.w=this.sb-20);this.isShow&&this.rSizeContent()};UIL.Bool=function(a){UIL.Proto.call(this,a);this.value=a.value||!1;this.buttonColor=UIL.BUTTON;this.inh=a.inh||this.h;a=~~(0.5*this.h)-0.5*(this.inh-2);this.c[2]=UIL.DOM(null,"div",UIL.BASIC+"background:"+UIL.BOOLBG+"; height:"+(this.inh-2)+"px; width:36px; top:"+a+"px; border-radius:20px; pointer-events:auto; cursor:pointer; transition:0.1s ease-out;");this.c[3]=UIL.DOM(null,"div",UIL.BASIC+"opasity:0, background:"+UIL.BOOLBG+"; height:"+(this.inh-6)+"px; width:"+(this.inh-6)+"px; top:"+(a+2)+"px; border-radius:20px; ");
...
UIL.Bool.prototype.update=function(){var a=this.s;this.value?(a[4].marginLeft="18px",a[2].background=this.fontColor,a[2].borderColor=this.fontColor,a[4].borderColor=this.fontColor):(a[4].marginLeft="0px",a[2].background=UIL.BOOLBG,a[2].borderColor=UIL.BOOLBG,a[4].borderColor=UIL.Border)};UIL.Button=function(a){UIL.Proto.call(this,a);this.value=a.value||!1;this.buttonColor=a.bColor||UIL.BUTTON;this.isLoadButton=a.loader||!1;this.isDragButton=a.drag||!1;this.r=a.r||0;this.c[2]=UIL.DOM(null,"div",UIL.BASIC+"border:1px solid "+UIL.Border+"; top:1px; pointer-events:auto; cursor:pointer; background:"+this.buttonColor+"; height:"+(this.h-2)+"px; border-radius:"+this.r+"px;");this.c[3]=UIL.DOM(null,"div",UIL.TXT+"text-align:center; height:"+(this.h-4)+"px; line-height:"+(this.h-8)+"px;");
this.c[3].style.color=this.fontColor;this.c[2].events=["click","mouseover","mousedown","mouseup","mouseout"];void 0!==this.c[1]&&(this.c[1].textContent="");this.c[3].innerHTML=this.txt;this.isLoadButton&&this.initLoader();this.isDragButton&&this.initDrager();this.init()};UIL.Button.prototype=Object.create(UIL.Proto.prototype);UIL.Button.prototype.constructor=UIL.Button;
UIL.Button.prototype.handleEvent=function(a){a.preventDefault();switch(a.type){case "click":this.click(a);break;case "mouseover":this.mode(1);break;case "mousedown":this.mode(2);break;case "mouseup":this.mode(0);break;case "mouseout":this.mode(0);break;case "change":this.fileSelect(a.target.files[0]);break;case "dragover":this.dragover();break;case "dragend":this.dragend();break;case "dragleave":this.dragend();break;case "drop":this.drop(a)}};
UIL.Button.prototype.dragover=function(){this.s[5].borderColor=UIL.SELECT;this.s[5].color=UIL.SELECT};UIL.Button.prototype.dragend=function(){this.s[5].borderColor=this.fontColor;this.s[5].color=this.fontColor};UIL.Button.prototype.drop=function(a){this.dragend();this.fileSelect(a.dataTransfer.files[0])};
UIL.Button.prototype.mode=function(a){var b=this.s;switch(a){case 0:b[3].color=this.fontColor;b[2].background=this.buttonColor;break;case 1:b[3].color="#FFF";b[2].background=UIL.SELECT;break;case 2:b[3].color=this.fontColor,b[2].background=UIL.SELECTDOWN}};
UIL.Button.prototype.initDrager=function(){this.c[5]=UIL.DOM("UIL text","div"," text-align:center; line-height:"+(this.h-8)+"px; border:1px dashed "+this.fontColor+"; top:2px; pointer-events:auto; cursor:default; height:"+(this.h-4)+"px; border-radius:"+this.r+"px;");this.c[5].textContent="DRAG";this.c[2].events=[];this.c[5].events=["dragover","dragend","dragleave","drop"]};
UIL.Button.prototype.initLoader=function(){this.c[4]=UIL.DOM("UIL","input","border:1px solid "+UIL.Border+"; top:1px; opacity:0; pointer-events:auto; cursor:pointer; height:"+(this.h-2)+"px;");this.c[4].name="loader";this.c[4].type="file";this.c[2].events=[];this.c[4].events=["change","mouseover","mousedown","mouseup","mouseout"]};
UIL.Button.prototype.fileSelect=function(a){this.c[4].type="null";if(void 0!==a){var b=new FileReader,c=a.name,d=c.substring(c.indexOf(".")+1,c.length);"png"===d||"jpg"===d?b.readAsDataURL(a):"z"===d?b.readAsBinaryString(a):b.readAsText(a);b.onload=function(a){this.callback(a.target.result,c,d);this.c[4].type="file"}.bind(this)}};UIL.Button.prototype.click=function(a){this.send()};UIL.Button.prototype.label=function(a){this.c[3].textContent=a};
UIL.Button.prototype.icon=function(a,b){this.s[3].padding=(b||0)+"px 0px";this.c[3].innerHTML=a};UIL.Button.prototype.rSize=function(){UIL.Proto.prototype.rSize.call(this);var a=this.s,b=this.sb,c=this.sa;this.isDragButton&&(b=0.5*b-5,a[5].left=c+b+5+"px",a[5].width=b+"px");a[2].left=c+"px";a[2].width=b+"px";a[3].left=c+"px";a[3].width=b+"px";a[4]&&(a[4].left=c+"px",a[4].width=b+"px")};UIL.Circular=function(a){UIL.Proto.call(this,a);this.autoWidth=!1;this.buttonColor=UIL.BUTTON;this.setTypeNumber(a);this.radius=a.radius||15;this.width=2*this.radius+20;void 0!==a.width&&(this.width=a.width,this.radius=0.5*~~(this.width-20));void 0!==a.size&&(this.width=a.size,this.radius=0.5*~~(this.width-20));this.w=this.height=2*this.radius;this.h=a.height||this.height+40;this.twoPi=2*Math.PI;this.top=0;this.c[0].style.width=this.width+"px";void 0!==this.c[1]&&(this.c[1].style.width=this.width+
...
"x"+this.value[0]+" y"+this.value[1];UIL.setSvg(this.c[3],"cx",d);UIL.setSvg(this.c[3],"cy",e);UIL.setSvg(this.c[4],"cx",b);UIL.setSvg(this.c[4],"cy",c);this.oldx=this.x;this.oldy=this.y;a&&this.send();null!==this.interval&&0===this.x&&0===this.y&&(clearInterval(this.interval),this.interval=null)};UIL.Fps=function(a){UIL.Proto.call(this,a);this.autoHeight=!0;this.baseH=this.h;this.hplus=50;this.c[1].textContent="FPS";this.c[0].style.cursor="pointer";this.c[0].style.pointerEvents="auto";this.c[2]=UIL.DOM(null,"div",UIL.BASIC+"display:none; left:10px; top:"+this.h+"px; height:"+(this.hplus-10)+"px; ");this.c[3]=UIL.DOM(null,"div",UIL.BASIC+"display:none; left:10px; top:"+this.h+"px; height:"+(this.hplus-10)+"px; ");this.c[4]=UIL.DOM(null,"div",UIL.BASIC+"display:none; left:10px; top:"+this.h+
"px; height:"+(this.hplus-10)+"px; ");this.isShow=a.show||!1;this.now=self.performance&&self.performance.now?self.performance.now.bind(performance):Date.now;this.prevTime=this.startTime=this.now();this.frames=0;this.isMem=!1;this.mm=this.mem=this.fps=this.ms=0;this.nFrame=40;self.performance&&self.performance.memory&&(this.isMem=!0);this.initGraph(1);this.c[0].events=["click","mousedown","mouseover","mouseout"];this.init()};UIL.Fps.prototype=Object.create(UIL.Proto.prototype);
UIL.Fps.prototype.constructor=UIL.Fps;UIL.Fps.prototype.handleEvent=function(a){a.preventDefault();switch(a.type){case "click":this.click(a);break;case "mouseover":this.mode(1);break;case "mousedown":this.mode(2);break;case "mouseout":this.mode(0)}};UIL.Fps.prototype.click=function(a){this.isShow?this.hide():this.show()};
UIL.Fps.prototype.mode=function(a){var b=this.s;switch(a){case 0:b[1].color=this.fontColor;b[1].background="none";break;case 1:b[1].color="#FFF";b[1].background=UIL.SELECT;break;case 2:b[1].color=this.fontColor,b[1].background=UIL.SELECTDOWN}};
UIL.Fps.prototype.initGraph=function(a){for(var b,c,d=0;d<this.nFrame;d++)b=document.createElement("span"),c=document.createElement("span"),b.style.cssText="position:relative; width:"+a+"px; height:1px; top:38px; float:left; border-bottom: 1px solid rgba(0,0,0,0.5); background:#CCC;  pointer-events:none;",c.style.cssText="position:relative; width:"+a+"px; height:1px; top:38px; float:left; border-bottom: 1px solid rgba(0,0,0,0.5); background:#CC0;  pointer-events:none;",this.c[2].appendChild(b),this.c[3].appendChild(c),
this.isMem&&(b=document.createElement("span"),b.style.cssText="position:relative; width:"+a+"px; height:1px; top:38px; float:left; border-bottom: 1px solid rgba(0,0,0,0.5); background:#0CC;  pointer-events:none;",this.c[4].appendChild(b))};UIL.Fps.prototype.resizeGraph=function(a){for(var b=0;b<this.nFrame;b++)this.c[2].children[b].style.width=a+"px",this.c[3].children[b].style.width=a+"px",this.isMem&&(this.c[4].children[b].style.width=a+"px")};
UIL.Fps.prototype.drawGraph=function(){var a=this.c[2].appendChild(this.c[2].firstChild);a.style.top=8+Math.min(30,30-this.fps/100*30)+"px";a=this.c[3].appendChild(this.c[3].firstChild);a.style.top=8+Math.min(30,30-this.ms/200*30)+"px";this.isMem&&(a=this.c[4].appendChild(this.c[4].firstChild),a.style.top=8+Math.min(30,30-30*this.mm)+"px")};
UIL.Fps.prototype.show=function(){this.h=this.hplus+this.baseH;null!==this.parentGroup?this.parentGroup.calc(this.hplus):this.isUI&&this.main.calc(this.hplus);this.s[0].height=this.h+"px";this.s[2].display="block";this.s[3].display="block";this.s[4].display="block";this.isShow=!0;UIL.addListen(this)};
UIL.Fps.prototype.hide=function(){this.h=this.baseH;null!==this.parentGroup?this.parentGroup.calc(-this.hplus):this.isUI&&this.main.calc(-this.hplus);this.s[0].height=this.h+"px";this.s[2].display="none";this.s[3].display="none";this.s[4].display="none";this.isShow=!1;UIL.removeListen(this);this.c[1].textContent="FPS"};
UIL.Fps.prototype.rSize=function(){this.s[0].width=this.width+"px";this.s[1].width=this.width+"px";var a=Math.floor((this.width-20)/this.nFrame),b=a*this.nFrame,c=Math.round(0.5*(this.width-b));this.s[2].left=c+"px";this.s[3].left=c+"px";this.s[4].left=c+"px";this.s[2].width=b+"px";this.s[3].width=b+"px";this.s[4].width=b+"px";this.resizeGraph(a)};UIL.Fps.prototype.begin=function(){this.startTime=this.now()};
UIL.Fps.prototype.end=function(){var a=this.now();this.ms=a-this.startTime;this.frames++;if(a>this.prevTime+1E3&&(this.fps=Math.round(1E3*this.frames/(a-this.prevTime)),this.prevTime=a,this.frames=0,this.isMem)){var b=performance.memory.usedJSHeapSize,c=performance.memory.jsHeapSizeLimit;this.mem=Math.round(9.54E-7*b);this.mm=b/c}this.drawGraph();this.c[1].innerHTML="FPS "+this.fps+' . <font color="yellow"> MS '+(this.ms|0)+'</font> . <font color="cyan"> MB '+this.mem+"</font>";return a};
